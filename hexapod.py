...
class Hexapod2axis(Robotics):
    ...
    def on_forward(self):
        ...
        self.driver.to_angle(0, 60)
        time.sleep(0.004)
        self.driver.to_angle(6, -30)
        time.sleep(0.004)
        ...
        time.sleep(0.004)
        self.driver.to_angle(4, -30)
        time.sleep(0.004)
        self.driver.to_angle(10, 60)
        time.sleep(0.004)
        ...
        self.driver.to_angle(6, 30)
        time.sleep(0.004)
        self.driver.to_angle(8, -60)
        time.sleep(0.004)

        self.driver.to_angle(2, -60)
        time.sleep(0.004)
        self.driver.to_angle(4, 30)
        time.sleep(0.004)
